...
class LunchBox2 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text("Lunch Box #2", style: TextStyle(color: Color(0xFFBC9C22), fontSize: 35, fontFamily: 'BonheurRoyale')),
          const Padding(
            padding: EdgeInsets.all(20.0),
            child: Text("Beef Teriyaki, Nasi Putih, & Salad Mayo", style: TextStyle(color: Colors.white, fontSize: 18), textAlign: TextAlign.center),
          ),
          const Spacer(),
          ElevatedButton(
            ...
            onPressed: () => _order(context, "Lunch Box #2", 35000, "Beef Teriyaki, Nasi Putih, & Salad Mayo", 'assets/images/db2be0683f97128e0d0b88fc5f30bfb4.jpg'),
